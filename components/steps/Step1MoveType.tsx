...
const MOVE_TYPES: { value: MoveType; icon: string; title: string; description: string }[] = [
  {
    ...
    icon: "🏠",
    title: "Home move",
    description: "House or apartment move with furniture and boxes.",
  },
  {
    value: "office",
    icon: "🏢",
    title: "Office / commercial move",
    description: "Desks, equipment and business items.",
  },
  {
    value: "partial",
    icon: "📦",
    title: "Partial / small move",
    description: "A few items, one room or selected furniture.",
  },
  {
    value: "storage",
    icon: "🔒",
...
export default function Step1MoveType({ data, onChange, onNext, onBack }: Props) {
  ...
  return (
    <div className="animate-in">
      ...
      <h2 className="text-2xl font-bold text-white mb-2">What type of move is it?</h2>
        ...
        {MOVE_TYPES.map((type) => (
          ...
          >
            ...
            <div
              ...
              style={{
                borderColor: data.moveType === type.value ? "#3b82f6" : "#1e3a5f",
                backgroundColor: data.moveType === type.value ? "#3b82f6" : "transparent",
              }}
            >
